...
export default {
  register(formData, formName, formSchema) {
    return {
      ...
      payload: { form: formName, data: formData, schema: formSchema },
    };
  },
  ...
  addElementToArrayField(arrayField, valueToAdd, formName) {
    return {
      type: ActionTypes.ADD_VALUE_TO_ARRAY_FIELD,
  ...
  removeElementFromArrayField(arrayField, index, formName) {
    return {
      type: ActionTypes.REMOVE_VALUE_FROM_ARRAY_FIELD,
